...
export class User extends BaseEntity {
  ...
  @OneToMany((type) => Machine_Entity, (machine) => machine.user, {
    eager: true,
  })
  ...
  @OneToMany((type) => Irrigation_m, (irrigation) => irrigation.user, {
    eager: true,
  })
  irrigation_m: Irrigation_m[];

  @OneToMany((type) => IrrigationEntity, (irrigation) => irrigation.user, {
    eager: true,
  })
  ...
  @OneToMany((type) => Device_Stat_Entity, (device) => device.user, {
    eager: true,
  })
  device: Device_Stat_Entity[];

  @OneToMany((type) => Envir_Entity, (envir_stat) => envir_stat.user, {
    eager: true,
  })
